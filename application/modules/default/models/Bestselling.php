...
*-----------------------------------------------------------------*
* Project	:	GetLinc
* File		:	Bestselling.php 
* Module	:	Best Selling Products Module
* Owner		:	RAM's 
* Purpose	:	This class is used for Best Selling Products management operations
* Date		:	08/05/2012
...
class Default_Model_Bestselling extends Default_Model_Bestsellingdb {
