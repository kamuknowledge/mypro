...
* Owner		:	RAM's 
* Purpose	:	This class is used for Brands Products management operations
* Date		:	08/05/2012
...
class Default_Model_Brands extends Default_Model_Brandsdb {
	...
	public function __construct(){		
		...
		$this->bestsellingdb=new Default_Model_Brandsdb();
