...
* Project	:	GetLinc
* File		:	index.php 
* Module	:	Home Page Product Management Module
* Owner		:	RAM's 
* Purpose	:	This class is used for home product management operations
* Date		:	08/05/2012
...
class Default_Model_index extends Application_Model_Validation {
